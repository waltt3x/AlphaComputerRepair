...
class Computer_Repair_Shop_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function computer_repair_shop_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function computer_repair_shop_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function computer_repair_shop_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function computer_repair_shop_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->computer_repair_shop_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function computer_repair_shop_load( $class ) {
